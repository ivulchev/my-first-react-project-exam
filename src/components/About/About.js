...
function About() {
    ...
    <h3>About Website</h3>
    <p>
    It is my first time to make a project. It is about one of my favourite sports Formula 1. So let me explain you shortly how the app works.... <br/> The app has some dynamic pages with drivers, teams and posts. They are reachable by every user, but guests cannot make interaction with them. The page has likes for every team, driver or post, for just one time. Can't be voted twice per object. In section Top Voted you can see the drivers and teams with most highest rating of voting. In All posts page you will see all posts created by users, you can sort them by likes, newest and comments. If you are logged in you can create post via button in the section. Just write name and paste image url in modal box and click post. Also if you are logged you can vote and comment on posts. Owners of posts can't vote for them but can do edit and delete operation. The posts also have comments and liked by option. In liked by you can see other users who are voted for the post. The App also has details page for every driver and team. For some interactions with objects and some authentication services the app has alerts and modal dialog boxes. The page has login, register and logout services. For them I used Firebase authentication services. Pages Calendar and Standings makes request to external API with live time information about points and races. This API has limit of 250 request per month and if this limit is reached you can't load the live tables for drivers and constructors and calendar for 2022 season. I used React.js for this App. For database I used realtime database from Firebase. HTML and CSS are written by me. Only toast and modalboxes are from React.Bootstrap and I stylized them. You can see the code at my GitHub Profile. You can find my Profile at the Footer.<br/> The site is responsive at max width 500px and max width 780px.
    </p>
    </section>
